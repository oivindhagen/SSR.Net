...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-dom`;
  ...
  var { createComponentInstance: createComponentInstance2, setCurrentRenderingInstance: setCurrentRenderingInstance2, setupComponent: setupComponent2, renderComponentRoot: renderComponentRoot2, normalizeVNode: normalizeVNode2 } = ssrUtils;
  ...
  function renderComponentSubTree(instance, slotScopeId) {
    ...
    const { getBuffer, push } = createBuffer();
    if (isFunction(comp)) {
      let root = renderComponentRoot2(instance);
      if (!comp.props) {
  ...
  // sfc-script:D:\Dokumenter\Programmering\SSR.Net\src\SSR.Net.DotNetFramework\Vue3Source\src\Components\Example.vue?type=script
  ...
  // sfc-template:D:\Dokumenter\Programmering\SSR.Net\src\SSR.Net.DotNetFramework\Vue3Source\src\Components\Example.vue?type=template
  ...
  Example_default.render = render;
  Example_default.__file = "src\\Components\\Example.vue";
  var Example_default2 = Example_default;
